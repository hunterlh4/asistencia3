            ...
            <div class="row">
              ...
              <div class="form-group col-xl-3 col-lg-4 col-md-6 col-sm-12">
                ...
                <div class="input-group">
                  ...
                  <input type="text" class="form-control" placeholder="Nombre" name="nombre" id="nombre" minlength="5" maxlength="30" required>
                </div>
              ...
              <div class="form-group col-xl-3 col-lg-4 col-md-6 col-sm-12">
                ...
                <div class="input-group">
                  ...
                  <input type="text" class="form-control" placeholder="Apellido" name="apellido" id="apellido" minlength="3" maxlength="30" required>
                </div>
              ...
              <div class="form-group col-xl-3 col-lg-4 col-md-6 col-sm-12">
                ...
                <div class="input-group">
                  ...
                  <input type="Date" class="form-control" placeholder="YYYY/MM/DD" name="nacimiento" id="nacimiento" required>
                </div>
              </div>
              <!-- sexo -->
              <div class="form-group col-xl-3 col-lg-4 col-md-6 col-sm-12">
