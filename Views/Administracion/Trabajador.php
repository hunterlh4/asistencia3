            ...
            <div class="col-md-4 col-sm-6">
              <div class="form-group">
                ...
                <div class="input-group">
                  ...
                  <input type="text" class="form-control phone-number" placeholder="Telefono" name="telefono" id="telefono" minlength="3" maxlength="50" required>
                </div>
              </div>
            </div>
            <!--  -->
            <div class="col-md-4 col-sm-6">
              <div class="form-group">
                ...
                <div class="input-group">
                  ...
                  <input type="text" class="form-control" placeholder="Tarjeta" name="tarjeta" id="tarjeta" minlength="3" maxlength="50" required>
                </div>
              </div>
            </div>
            ...
            <div class="col-md-6 col-sm-6">
              ...
              <label>Correo</label>
                <div class="input-group">
                  ...
                  <input type="email" class="form-control" placeholder="Correo" name="email" id="email" minlength="5" maxlength="50" required>
                </div>
              </div>
            </div>
              ...
              <div class="form-group">
                <label for="direccion">Direccion</label>
                  <div class="input-group">
                    ...
                    <option value="0" selected>Selecciona una Direccion</option>
          ...
          <div class="row"> -->
            <div class="col-md-4 col-sm-6">
              ...
              <label>Regimen</label>
                <div class="input-group">
                    ...
                    <option value="0" selected>Selecciona un Regimen</option>
                    <!-- Opciones para la dirección -->
                  </select>
                </div>
              </div>
            ...
            <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <option value="Trabajo Presencial" selected>Trabajo Presencial</option>
                    <option value="Trabajo Remoto" selected>Trabajo Remoto</option>
                    <option value="Licencia con Goce de Haber" selected>Licencia con Goce de Haber</option>
          ...
          <div class="col-md-6 col-sm-6">
            <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <option value="0" selected>Selecciona un Horario</option>
                    <!-- Opciones para la dirección -->
                  </select>
                  </div>
                </div>
              ...
              <div class="col-md-6">
                  ...
                  <div class="form-group" id="estado-grupoA">
                  <label>Estado</label>
                    <div class="input-group">
                      <div class="col-sm-9 d-flex align-items-center mt-1">
                        <div class="custom-control custom-radio mr-3">
