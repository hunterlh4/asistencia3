...
class HorarioDetalle extends Controller
{
    ...
    public function index()
    {
        ...
        // $data['detalle'] = $datos['valor'];
      
        // $data1 = $this->listar($id);
    ...
    //             $respuesta = array('msg' => 'tiene datos', 'icono' => 'warning');
    //         }
            
          
    //     }else{
    //         $respuesta = array('msg' => 'vacio', 'icono' => 'warning');
    //     }
            ...
            if ((empty($nombre)|| (empty($entrada) || (empty($salida))))) {
                ...
                if (!empty($error_msg)) {
                    ...
                    if (empty($id)) {
                            ...
                            $data = $this->model->registrar($nombre,$horario_id,$entrada,$salida);
                        ...
                        // MODIFICAR
                                ...
                                $data = $this->model->modificar($nombre,$horario_id,$entrada,$salida, $estado, $id);
                                if ($data == 1) {
