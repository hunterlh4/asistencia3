...
$(function () {
  ...
  var update_sidebar_nicescroll = function () {
    let a = setInterval(function () {
      ...
      if (sidebar_nicescroll !== null && Object.keys(sidebar_nicescroll[0]).length !== 0) sidebar_nicescroll.resize();
    }, 10);
  ...
  function pintar_blanco_sidebar(){
    $("body").removeClass("dark-sidebar");
    $("body").addClass("light-sidebar");
    $("#barra_1").attr("checked", true);
    $("#barra_2").removeAttr("checked", true);
    localStorage.setItem("sidebar", "1");
  }

  function pintar_negro_sidebar(){
    $("body").removeClass("light-sidebar");
    $("body").addClass("dark-sidebar");
    $("#barra_2").attr("checked", true);
    $("#barra_1").removeAttr("checked", true);
    localStorage.setItem("sidebar", "2");
  }
  $(document).ready(function(){
    var valor_sidebar = localStorage.getItem("sidebar");
    if (valor_sidebar == 1){
      pintar_blanco_sidebar();
    } else if(valor_sidebar == 2) {
      pintar_negro_sidebar();
    } else {
      localStorage.setItem("sidebar", valor_sidebar);
    }
  });
  ...
  function pintar_blanco(){
    ...
    $("#boton_1").attr("checked", true);
    $("#boton_2").removeAttr("checked", true);

    localStorage.setItem("darkSwitch", "1");
  }
  ...
  function pintar_negro(){
    ...
    $("#boton_2").attr("checked", true);
    $("#boton_1").removeAttr("checked", true);

    localStorage.setItem("darkSwitch", "2");
  }
  function colorear(){
    var white = $('#white').hasClass("active");
    var cyan = $('#cyan').hasClass("active");
    
    if(white == "1"){
      localStorage.setItem("color", "white");
      var color_theme = localStorage.getItem("color");
    } else if(cyan == "1"){
  ...
  $(document).ready(function(){
    colorear();
    var valor_dark = localStorage.getItem("darkSwitch");
    var valor_sidebar = localStorage.getItem("sidebar");
    ...
    } else if(valor_dark == 2 && valor_sidebar == 2) {
        pintar_negro();
        pintar_negro_sidebar();
    } else if(valor_dark == 2 && valor_sidebar == 1) {
        pintar_negro();
        pintar_blanco_sidebar();
        localStorage.setItem("darkSwitch", valor_dark);
    } else {
      localStorage.setItem("darkSwitch", valor_dark);
    }
  });
