...
class ImportarModel extends Query
{
    ...
    {
        $sql = "SELECT id,telefono_id FROM trabajador WHERE telefono_id = '$telefono_id' ";
    ...
    {
        $sql = "INSERT INTO asistencia (trabajador_id,licencia_id,fecha,entrada,salida,total_reloj,total,tarndaza,tardanza_cantidad,justificacion,reloj_1,reloj_2,reloj_3,reloj_4,reloj_5,reloj_6,reloj_7,reloj_8) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
